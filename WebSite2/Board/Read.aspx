<%@ Page Title="" Language="C#" MasterPageFile="~/top.master" AutoEventWireup="true" CodeFile="Read.aspx.cs" Inherits="Board_Read" %>
...
<asp:Content ID="cntContent" ContentPlaceHolderID="cphContent" Runat="Server">
    ...
    <table class="tbl01" cellpadding="0" cellspacing="0">
            ...
            <table class="tbl01" cellpadding="0" cellspacing="0">
                ...
                <tr><td class="td04" style="width: 29px">· 작성자</td>
                    <td>
                        <asp:Label ID="lblWriter" runat="server" Text="Label"></asp:Label>
                    </td></tr>
                <tr><td colspan="2" class="td08"></td></tr>
                <tr><td class="td04" style="width: 29px">· 작성 날짜</td>
                    <td>
                        <asp:Label ID="lblRegDate" runat="server" Text="Label"></asp:Label>
                    </td></tr>
                <tr><td colspan="2" class="td08"></td></tr>
                <tr><td class="td04" style="width: 29px">· 제목</td>
                    <td>
                        <asp:Label ID="lblTitle" runat="server" Text="Label"></asp:Label>
                    </td></tr>
                <tr><td colspan="2" class="td08"></td></tr>
                <tr>
                    <td style="padding-left:20px; padding-top:7px; width: 29px;" valign="top">· 내용</td>
                    <td class="p02">
